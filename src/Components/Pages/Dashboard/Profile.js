...
const Profile = ({profile}) => {
    ...
    const{url,phone,address} = profile;
                        ...
                        <div className="card w-80 flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                            <div className="card-body">
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" value={phone} className="input input-bordered" />
                                   
                                </div>
                                <div className="form-control">
                                    
                                    <input type="text" value={address} className="input input-bordered" />
                                   
                                </div>
                                <div className="form-control">
                                   
                                    <input type="url" value={url} className="input input-bordered" />
